...
angular.module('cssBoxModel')
    .controller('MainCtrl', function($scope) {
        ...
        //starts @ content-box: "width" + padding + border =>
              // width: 220 + 40 + 30 = 290
              // height: 22 + 40 + 30 = 290
        //= GENERATED INNER CONTENT BOX DIMENSIONS
        $scope.generatedContentBoxDimensions = {
            width: 290,
            height: 290
        }
        ...
        $scope.$watch(function() {
            ...
            $scope.generatedContentBoxDimensions.width = getgeneratedContentBoxDimensionsWidth();
            $scope.generatedContentBoxDimensions.height = getgeneratedContentBoxDimensionsHeight();
        });
        ...
        function getgeneratedContentBoxDimensionsWidth() {
            if ($scope.box.sizing === 'border-box') {
        ...
        function getgeneratedContentBoxDimensionsHeight() {
            if ($scope.box.sizing === 'border-box') {
